...
> **Conflicts with:** `/init-onecli`. These are mutually exclusive credential strategies. If OneCLI is active, this skill will replace it with the native `.env`-based proxy. To go the other direction, use `/init-onecli`.
